...
// Fetch all students
$query = "SELECT fname, mname, lname, year_level, program, sex, username, created_at 
          FROM users 
          WHERE role='student' 
          ORDER BY lname ASC";
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    ...
    <a href="studentlist.php" class="active"><i class="fas fa-user-graduate"></i> Student List</a>
          ...
          <?php if ($result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                  <a href="delete_student.php?username=<?php echo urlencode($row['username']); ?>" 
                     class="remove-btn"
